...
1. **CrosspostBot** — Multi-platform social media distribution automation engine (FastAPI, Python, Telegram Bot API, YouTube Data API, Instagram Graph API, TikTok API, AWS S3, OAuth 2.0).
2. **CertLingo (EduTest)** — AI-powered international language certification testing suite (Next.js 14 App Router, TypeScript, Tailwind CSS, PostgreSQL, Prisma ORM, Redis, OpenAI GPT-4, Telegram Mini App).
3. **DeutschLab & UzDeBot** — High-throughput Telegram bot and asynchronous backend for Telc B1 German exam preparation (Python 3, aiogram 3.7, FastAPI, aiosqlite).
4. **AI Cinematic & Video Experiments** — Generative AI video workflows, procedural WebGL optical glass shaders, and audio-reactive interfaces.
5. **Automation & Integration Suite** — Cloud schedulers, background workers, and resilient webhook microservices.
...
© 2026 Ali Akbar Junaydullayev. All rights reserved.
